...
export JENKINS_X_URL='https://dashboard-jx.dev.jenkins-x.me/jenkins-x/jx-git-operator/master/6'
export JX_CHART_REPOSITORY='http://jenkins-x-chartmuseum.jx.svc.cluster.local:8080'
export MINK_AS='tekton-bot'
export MINK_IMAGE='gcr.io/jenkinsxio/jx-git-operator:0.0.175'
